...
def add_newstudent():
    add_newstudent = students_managment()
    students_details.append(add_newstudent)
add_newstudent()   
print("New and Old students details: ", students_details)
'''
def remove_students():
    n = int(input("Enter an index number : "))
    students_details.pop(n)
    return students_details
remove_students()
print("Students_details after reomve the some students : ", students_details)
